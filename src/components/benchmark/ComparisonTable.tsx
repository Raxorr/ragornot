      ...
      <table className="w-full min-w-[640px] border-collapse text-left text-sm">
        ...
        <thead>
          <tr className="border-b border-border bg-surface-2">
            ...
            <th scope="col" className="px-4 py-3 font-semibold text-text">Accuracy</th>
            <th scope="col" className="px-4 py-3 font-semibold text-text">Latency</th>
            <th scope="col" className="px-4 py-3 font-semibold text-text">Cost / query</th>
            <th scope="col" className="px-4 py-3 font-semibold text-text">What it means</th>
          </tr>
        </thead>
        <tbody>
          {data.map((row) => (
