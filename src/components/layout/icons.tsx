// Small inline icon set — avoids an icon-library dependency for ~6 glyphs.
// Every icon here is decorative; the interactive elements that use them
// supply their own aria-label, so these all carry aria-hidden="true".
...
export function MoonIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M20.5 14.6a8.5 8.5 0 0 1-11-11 .6.6 0 0 0-.77-.76A9.7 9.7 0 1 0 21.26 15.4a.6.6 0 0 0-.76-.8Z" />
    </svg>
  );
}
